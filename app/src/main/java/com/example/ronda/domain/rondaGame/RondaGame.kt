...
//import com.example.ronda.domain.card.DeckBackCard
...
//}
//class RondaGame() {
//    val gridManager = GridManager(4, 4)
//    private val cellOccupancy: MutableMap<CellId, Pair<User, Card>> = mutableMapOf()
//    val loadedCards = mutableMapOf<CardId, Triple<User, CellId, Card>>()
//    val usedCards = mutableSetOf<Card>()
//    val userCards = mutableMapOf<User, MutableList<Card>>()
//    val deckCard = DeckBackCard
